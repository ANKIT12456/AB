class MAP{
    ...
    display(){
        ...
        this.level1.position(windowWidth/2-200,windowHeight/2-150);
        this.level1.style("width",'75px');
        this.level1.style('height','75px');
        this.level1.style('color','yellow');
        this.level1.style('background','black');

        this.level2=createButton("LEVEL2");
        this.level2.position(windowWidth/2-100,windowHeight/2-150);
        this.level2.style("width",'75px');
        this.level2.style('height','75px');
        this.level2.style('color','yellow');
        this.level2.style('background','black');

        this.level3=createButton("LEVEL3");
        this.level3.position(windowWidth/2,windowHeight/2-150);
        this.level3.style("width",'75px');
        this.level3.style('height','75px');
        this.level3.style('color','yellow');
        this.level3.style('background','black');

        this.level4=createButton("LEVEL4");
        this.level4.position(windowWidth/2+100,windowHeight/2-150);
        this.level4.style("width",'75px');
        this.level4.style('height','75px');
        this.level4.style('color','yellow');
        this.level4.style('background','black');

        this.level5=createButton("LEVEL5");
        this.level5.position(windowWidth/2+200,windowHeight/2-150);
        this.level5.style("width",'75px');
        this.level5.style('height','75px');
        this.level5.style('color','yellow');
        this.level5.style('background','black');

        this.level6=createButton("LEVEL6");
        this.level6.position(windowWidth/2-200,windowHeight/2-300);
        this.level6.style("width",'75px');
        this.level6.style('height','75px');
        this.level6.style('color','yellow');
        this.level6.style('background','black');

        this.level7=createButton("LEVEL7");
        this.level7.position(windowWidth/2-100,windowHeight/2-300);
        this.level7.style("width",'75px');
        this.level7.style('height','75px');
        this.level7.style('color','yellow');
        this.level7.style('background','black');

        this.level8=createButton("LEVEL8");
        this.level8.position(windowWidth/2,windowHeight/2-300);
        this.level8.style("width",'75px');
        this.level8.style('height','75px');
        this.level8.style('color','yellow');
        this.level8.style('background','black');

        this.level9=createButton("LEVEL9");
        this.level9.position(windowWidth/2+100,windowHeight/2-300);
        this.level9.style("width",'75px');
        this.level9.style('height','75px');
        this.level9.style('color','yellow');
        this.level9.style('background','black');

        this.level10=createButton("LEVEL10");
        this.level10.position(windowWidth/2+200,windowHeight/2-300);
        this.level10.style("width",'75px');
        this.level10.style('height','75px');
        this.level10.style('color','yellow');
        this.level10.style('background','black');

        this.level11=createButton("LEVEL11");
        this.level11.position(windowWidth/2-200,windowHeight/2);
        this.level11.style("width",'75px');
        this.level11.style('height','75px');
        this.level11.style('color','yellow');
        this.level11.style('background','black');

        this.level12=createButton("LEVEL12");
        this.level12.position(windowWidth/2-100,windowHeight/2);
        this.level12.style("width",'75px');
        this.level12.style('height','75px');
        this.level12.style('color','yellow');
        this.level12.style('background','black');

        this.level13=createButton("LEVEL13");
        this.level13.position(windowWidth/2,windowHeight/2);
        this.level13.style("width",'75px');
        this.level13.style('height','75px');
        this.level13.style('color','yellow');
        this.level13.style('background','black');

        this.level14=createButton("LEVEL14");
        this.level14.position(windowWidth/2+100,windowHeight/2);
        this.level14.style("width",'75px');
        this.level14.style('height','75px');
        this.level14.style('color','yellow');
        this.level14.style('background','black');

        this.level15=createButton("LEVEL15");
        this.level15.position(windowWidth/2+200,windowHeight/2);
        this.level15.style("width",'75px');
        this.level15.style('height','75px');
        this.level15.style('color','yellow');
        this.level15.style('background','black');

        this.level16=createButton("LEVEL16");
        this.level16.position(windowWidth/2-200,windowHeight/2+150);
        this.level16.style("width",'75px');
        this.level16.style('height','75px');
        this.level16.style('color','yellow');
        this.level16.style('background','black');

        this.level17=createButton("LEVEL17");
        this.level17.position(windowWidth/2-100,windowHeight/2+150);
        this.level17.style("width",'75px');
        this.level17.style('height','75px');
        this.level17.style('color','yellow');
        this.level17.style('background','black');

        this.level18=createButton("LEVEL18");
        this.level18.position(windowWidth/2,windowHeight/2+150);
        this.level18.style("width",'75px');
        this.level18.style('height','75px');
        this.level18.style('color','yellow');
        this.level18.style('background','black');

        this.level19=createButton("LEVEL19");
        this.level19.position(windowWidth/2+100,windowHeight/2+150);
        this.level19.style("width",'75px');
        this.level19.style('height','75px');
        this.level19.style('color','yellow');
        this.level19.style('background','black');

        this.level20=createButton("LEVEL20");
        this.level20.position(windowWidth/2+200,windowHeight/2+150);
        this.level20.style("width",'75px');
        this.level20.style('height','75px');
        this.level20.style('color','yellow');
        this.level20.style('background','black');

        this.level21=createButton("LEVEL21");
        this.level21.position(windowWidth/2-200,windowHeight/2+300);
        this.level21.style("width",'75px');
        this.level21.style('height','75px');
        this.level21.style('color','yellow');
        this.level21.style('background','black');

        this.level22=createButton("LEVEL22");
        this.level22.position(windowWidth/2-100,windowHeight/2+300);
        this.level22.style("width",'75px');
        this.level22.style('height','75px');
        this.level22.style('color','yellow');
        this.level22.style('background','black');

        this.level23=createButton("LEVEL23");
        this.level23.position(windowWidth/2,windowHeight/2+300);
        this.level23.style("width",'75px');
        this.level23.style('height','75px');
        this.level23.style('color','yellow');
        this.level23.style('background','black');

        this.level24=createButton("LEVEL24");
        this.level24.position(windowWidth/2+100,windowHeight/2+300);
        this.level24.style("width",'75px');
        this.level24.style('height','75px');
        this.level24.style('color','yellow');
        this.level24.style('background','black');

        this.level25=createButton("LEVEL25");
        this.level25.position(windowWidth/2+200,windowHeight/2+300);
        this.level25.style("width",'75px');
        this.level25.style('height','75px');
