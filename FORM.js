class FORM{
    ...
    constructor(){
     ...
     display(){
         ...
         this.button.position(windowWidth/2-200,50);
        ...
        this.reset.position(windowWidth-200,20);
        ...
        this.button.mousePressed(() => {
            ...
            this.store.position(100,windowHeight-125);
            ...
            this.gunshop.position(250,windowHeight-125);
            ...
            this.canteen.position(400,windowHeight-125);
            ...
            this.islands.position(550,windowHeight-125);
            ...
            coinbar=createSprite(windowWidth/2+300,-55);
            coinbar.addImage(coinbarimg);
            coinbar.scale=0.4;

            energybar=createSprite(windowWidth/2-100,75);
            energybar.addImage(energybarimg);
            energybar.scale=0.4;

            healthbar=createSprite(windowWidth/2+100,135);
            healthbar.addImage(healthbarimg);
            healthbar.scale=0.4;

            leafbar=createSprite(windowWidth/2-300,20);
