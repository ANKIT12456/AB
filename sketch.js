...
function preload(){
	...
	//sound3=loadSound(sound,"button-11.mp3");
...
function draw(){
	...
	strokeWeight(20);
	fill("black");
	text(health,windowWidth/2-100,50);
	text(leaf,windowWidth/2-300,55);
	text(diamond,windowWidth/2+300,45);
	text(live,windowWidth/2+100,50);
}
